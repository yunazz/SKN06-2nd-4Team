...
>
임연경
> 저는 팀원들과 같이 머신러닝을 학습하는 과정을 맡고 파이프라인 제작을 위해 노력했지만 끝내 실패 하였습니다. 하지만 이 실패 속에서 문제를 해결하려는 끊임없는 시도와 학습은 제 역량을 한층 더 확장시켜 주었고, 다음에는 더 나은 결과를 만들어낼 자신감을 얻을 수 있었습니다.
>
